...
export type DefaultValueScope = 'ATTRIBUTE' | 'VERTICAL';

export class VerticalAttributeId {
  private constructor(public readonly value: string) {}

  static create(value?: string): VerticalAttributeId {
    return new VerticalAttributeId(value ?? randomUUID());
  }
}

export interface CreateVerticalAttributeProps {
  id?: string;
  verticalId: string;
  attributeId: string;
...
export class VerticalAttribute {
  private constructor(
    private readonly id: VerticalAttributeId,
    ...
    private readonly defaultValueScope: DefaultValueScope | null,
    private readonly defaultValueId: string | null,
    private readonly createdAt: Date,
    private readonly updatedAt: Date | null
  ) {}

  static create(props: CreateVerticalAttributeProps): VerticalAttribute {
    if (
      props.minValue !== null &&
    ...
    return new VerticalAttribute(
      VerticalAttributeId.create(props.id),
      props.verticalId,
      props.attributeId,
  ...
  getDefaultValueScope(): DefaultValueScope | null {
