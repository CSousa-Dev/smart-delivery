...
export class PaymentMismatchCartState implements CartStatusState {
  readonly status = CartStatus.PAYMENT_MISMATCH;

  canTransitionTo(_status: CartStatus): boolean {
    return _status === CartStatus.OPEN || _status === CartStatus.ABANDONED;
  }
