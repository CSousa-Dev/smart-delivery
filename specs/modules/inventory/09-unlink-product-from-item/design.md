...
O inventory e agnostico de produto. O desvinculo produto-item e responsabilidade do
modulo de producao.
...
- Endpoints de desvinculo (`/inventory/product-item-links/deactivate`) deixam de existir neste modulo.
