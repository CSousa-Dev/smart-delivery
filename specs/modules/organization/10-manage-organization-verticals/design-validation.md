## Avaliacao do Design: Manage Organization Verticals
...
1. Regra de manter ao menos uma vertical ativa esta protegida no fluxo.
2. Vinculo idempotente reduz erros e simplifica integracoes.
