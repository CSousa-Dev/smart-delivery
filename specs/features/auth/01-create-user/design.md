...
A capability **Create User** implementa a criação de uma **identidade administrativa** no contexto Auth.
...
Esta capability é a **porta de entrada obrigatória** para todas as demais funcionalidades do módulo Auth.
...
| --- | --- | --- | --- | --- |
| POST | `/users` | Criar identidade | 201 | 400, 409 |
