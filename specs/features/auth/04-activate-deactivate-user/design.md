...
sequenceDiagram
    ...
    Client->>Controller: POST /users/:id/activate
...
sequenceDiagram
    ...
    Client->>Controller: POST /users/:id/deactivate
    Controller->>AppService: ChangeUserStatusInput
...
| --- | --- | --- | --- | --- |
| POST | `/users/:id/activate` | Ativar usuário | 200 | 404 |
| POST | `/users/:id/deactivate` | Desativar usuário | 200 | 404 |
...
- Esta capability **não concede nem revoga permissões**
...
- Nenhuma integração com Permissions Provider
